...
2. 아래를 직접 확인한다 (에이전트 호출 없이 파일만 읽어 빠르게):
   - `00_input/raw/` 파일 수 vs `INDEX.md` 등록 수 → 미등록 자료
   - `01_data/CHANGELOG.md` 최근 변경
   - `02_legal/ISSUE_LOG.md` 심각도 高 미해결 이슈
   - `04_schedule/TIMELINE.md` 다음 마일스톤과 D-day, `ACTION_ITEMS.md` 기한 경과 항목
   - `05_finance_qa/QA_BANK.md` `[갱신 필요]` 항목
   - `06_decision/DECISION_LOG.md` 조건부 결정의 조건 이행 여부
